...
class HomeModel {
    loadSanPham(){
        return new Promise(function (resolve, reject) {
            let sqlquery = 'SELECT * FROM sanpham where isDelete = 0 and trangthai = 1 limit 0,6 ';
    ...
    loadSanPhamDealhot(){
        return new Promise(function (resolve, reject) {
            let sqlquerydeal = 'SELECT * FROM sanpham where isDelete = 0 and trangthai = 1 limit 6,6';
    ...
    loadSanPhamFeatured(){
        return new Promise(function (resolve, reject) {
            let sqlqueryfeature = 'SELECT * FROM sanpham where isDelete = 0 and trangthai = 1 limit 12,6';
    ...
    loadSanPhamDrew(){
        return new Promise(function (resolve, reject) {
            let sqlquerydrew = 'SELECT * FROM sanpham where isDelete = 0 and trangthai = 1 limit 18,6';
    ...
    loadSanPhamWatch(){
        return new Promise(function (resolve, reject) {
            let sqlquerywatch = 'SELECT * FROM sanpham where isDelete = 0 and trangthai = 1 limit 24,12';
    ...
    loadSanPhamLatest(){
        return new Promise(function (resolve, reject) {
            let sqlquerylatest = 'SELECT * FROM sanpham where isDelete = 0  and trangthai = 1 limit 36,4';
